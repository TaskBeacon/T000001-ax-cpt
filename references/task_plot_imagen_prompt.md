...
Visual requirements:
- White background, landscape orientation, crisp dark text, restrained accent colors.
...
- Use simple screen boxes with gray interiors to reflect the task's gray PsychoPy background.

Accuracy constraints:
- Do not invent phases, stimuli, condition names, keys, rewards, or timings.
- Do not add people, lab equipment, decorative scenes, logos, watermarks, or unrelated icons.
...
Style:
Minimal scientific infographic, clean vector-like raster image, organized spacing, professional task documentation figure.
